...
export const reportOrderSchema = z.object({ order_number: z.string(), placed_at: z.string(), business_date: z.string(), placed_at_local: z.string(), source: z.string(), fulfillment_type: z.string(), status: z.string(), payment_method: z.string(), discount_cents: z.number().int(), total_cents: z.number().int() });
