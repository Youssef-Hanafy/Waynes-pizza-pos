...
export function PosClient({ canManageDiscount, canManageOrders, canOpenAdmin, menu, settings, staffName }: Props) {
  ...
  return <div className="flex h-screen flex-col overflow-hidden bg-wayne-cream-deep">
    ...
    <main className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-[16.5rem_1fr_19.5rem] 2xl:grid-cols-[19rem_1fr_23rem]">
      <aside className="min-h-0 overflow-y-auto border-b border-wayne-border bg-white p-3 lg:border-b-0 lg:border-r">
