...
import { cartLineUnitCents, cartSubtotalCents, choicePriceDeltaCents, describeLineModifiers, findMenuItem, includedSelection, isIncludedChoice } from "@/lib/orders/cart";
...
export function PosClient({ canManageDiscount, canManageOrders, canOpenAdmin, menu, settings, staffName }: Props) {
  ...
  async function submitOrder() {
    ...
    const payload = {
      ...
      items: cart.map((line) => ({ menu_item_id: line.menu_item_id, variant_id: line.variant_id, quantity: line.quantity, special_instructions: line.special_instructions, modifiers: line.modifiers, lists_included: true })),
    };
    try {
